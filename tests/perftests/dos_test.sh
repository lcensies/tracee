...
PGBENCH_CLIENTS=25  # clients or concurrent db sessions
PGBENCH_RATE=10000  # rate limit, number of transactions per second
PGBENCH_THREADS=3   # number of threads to run to manage connections
PGBENCH_DURATION=30 # test duration
